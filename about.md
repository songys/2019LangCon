...
|7|튜토리얼|김영욱|한국마이크로소프트![김영욱](./pic/kimyoungok.png)|가장 빨리 만나는 챗봇 프로그래밍|가장 빨리 자연어 처리와 텍스트 마이닝 기술이 적용된 챗봇을 개발하고 싶은 사람들을 위한 Hands on Labs 세션입니다. 이 세션에서는 Microsoft Bot Framework를 사용해서 개발하고 있으며 Azure 기반으로 서비스 해 봅니다. **준비사항** https://github.com/KoreaEva/HOL/tree/master/Azure/20190216%20Chatbot | 
...
|17|스피커|정건용, 신민철|아주대학교 e-business학과![장건용](./pic/jang.png)|메세지(기사)와 메신저(기사 전달자)를 활용한 가짜뉴스 판별기 제작기|최근 문제가 되고있는 가짜뉴스를 판별할 수 있는 여러가지 Feature를 찾고, 가짜뉴스에 대한 통합적인 접근을 통해 가짜뉴스를 분류하는 알고리즘 프로세스 제안 **대상** : 초중급|
